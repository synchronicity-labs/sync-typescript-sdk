...
export class Analyze {
    constructor(protected readonly _options: Analyze.Options) {}

    /**
     * @param {Sync.CreateGenerationDto} request
     * @param {Analyze.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public async analyzeControllerGetCostEstimate(
